"""Demo seed data, importable without side effects.

Used by scripts/seed.py (local) and by the app's first-boot seeding (so a fresh
deploy is never blank). The source_key values match what the FTC scraper uses, so
real data updates these rows in place rather than duplicating them.
"""
...
DEMO = [
  dict(source_key="amazon-refunds", name="Amazon Refunds", company="Amazon",
       ...
       claim_url=None, source_url="https://www.ftc.gov/enforcement/refunds/amazon-refunds",
  ...
  dict(source_key="brigit-refunds", name="Brigit Refunds", company="Brigit",
       ...
       proof_required=False, claim_url=None,
